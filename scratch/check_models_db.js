...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var settings, apiKey, options, req;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.systemSettings.findUnique({ where: { id: 'default' } })];
                case 1:
                    settings = _a.sent();
                    ...
                    options = {
                        ...
                        path: "/v1beta/models?key=".concat(apiKey),
                        method: 'GET',
                    };
                    req = https_1.default.request(options, function (res) {
                        ...
                        res.on('end', function () {
                            if (res.statusCode === 200) {
                                ...
                                var supportedModels = json.models

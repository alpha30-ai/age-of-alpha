        ...
        <div className="max-w-7xl mx-auto">
          {chapters.length > 0 ? (
            ...
            <div className="text-center py-24 bg-white/5 border border-white/10 rounded-3xl backdrop-blur-xl">
              ...
              <p className="text-white text-xl font-bold font-cairo">لم تُنشر أي مخطوطات بعد</p>
              <p className="text-gray-400 mt-3">تأكد من اتصال قاعدة البيانات وتشغيل البيانات التجريبية</p>
            </div>
          )}
        </div>
      </div>

  ...
  return (
    <footer className="relative bg-abyss text-gray-400 overflow-hidden font-tajawal">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 lg:gap-8 mb-16 border-b border-silver-ash/5 pb-16">
          
          {/* Brand & Description */}
          <div className="col-span-1 md:col-span-5 space-y-6">
            <Link href="/" className="inline-flex items-center gap-3 group">
              <div className="relative flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-stone to-abyss border border-[var(--theme-primary)]/30 group-hover:border-[var(--theme-primary)] shadow-[0_0_20px_color-mix(in_srgb,var(--theme-primary)_10%,transparent)] group-hover:shadow-[0_0_30px_color-mix(in_srgb,var(--theme-primary)_30%,transparent)] transition-all duration-500">
                <Flame className="w-6 h-6 text-[var(--theme-primary)] group-hover:scale-110 transition-transform duration-500" />
              </div>
              <div>
                <span className="block font-amiri font-bold text-3xl tracking-wide text-silver-ash group-hover:text-[var(--theme-primary)] transition-colors duration-500">
                  عهد ألفا
                </span>
            ...
            <div className="flex items-center gap-3 pt-4">
              <a href="#" className="relative p-3 rounded-xl bg-stone-dark border border-silver-ash/10 hover:border-[var(--theme-primary)]/50 group transition-all duration-500 overflow-hidden">
                ...
                <MessageCircle className="w-5 h-5 text-gray-500 group-hover:text-silver-ash relative z-10 transition-colors" />
              </a>
              <a href="https://www.youtube.com/@AlphaStudio-H" target="_blank" rel="noopener noreferrer" className="relative p-3 rounded-xl bg-stone-dark border border-silver-ash/10 hover:border-[var(--theme-primary)]/50 group transition-all duration-500 overflow-hidden">
                ...
                <Play className="w-5 h-5 text-gray-500 group-hover:text-silver-ash relative z-10 transition-colors" fill="currentColor" />
              </a>
              <a href="#" className="relative p-3 rounded-xl bg-stone-dark border border-silver-ash/10 hover:border-[var(--theme-primary)]/50 group transition-all duration-500 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-tr from-[var(--theme-primary)]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                <Globe className="w-5 h-5 text-gray-500 group-hover:text-silver-ash relative z-10 transition-colors" />
              </a>
            </div>
          </div>
          ...
          <div className="col-span-1 md:col-span-3 space-y-8 mt-2">
            <h3 className="font-bold text-lg text-silver-ash flex items-center gap-2">
          ...
          <div className="col-span-1 md:col-span-4 space-y-6 mt-2">
            <h3 className="font-bold text-lg text-silver-ash">
              انضم إلى النخبة
            </h3>
        ...
        {/* Copyright */}
        <div className="flex items-center justify-center mt-12 pt-8 border-t border-silver-ash/5">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 py-6 md:py-8 flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6 relative z-10">
          ...
          <div className="flex items-center gap-3">
             <div className="flex items-center justify-center w-10 h-10 rounded-full bg-white/5 border border-silver-ash/10 group-hover:bg-[var(--theme-primary)]/20 group-hover:border-[var(--theme-primary)]/50 transition-all duration-500 group-hover:scale-110 shadow-[0_0_15px_rgba(0,0,0,0.5)] group-hover:shadow-[0_0_20px_color-mix(in_srgb,var(--theme-primary)_30%,transparent)]">
               <Code2 className="w-5 h-5 text-gray-400 group-hover:text-silver-ash transition-colors" />
             </div>

...
export default function PostCard({ post, currentUser, onDeleted }: PostCardProps) {
  ...
  return (
    <motion.div 
      ...
      className="bg-[#111]/80 backdrop-blur-xl border border-white/5 rounded-3xl p-6 shadow-xl relative group hover:border-[var(--color-magma)]/30 transition-all duration-300 overflow-hidden"
      dir="rtl"
    >
